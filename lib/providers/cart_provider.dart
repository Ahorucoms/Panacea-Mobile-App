...
class CartProvider with ChangeNotifier {
  ...
  Future<double?> getCartTotal() async {
    ...
    snapshot.docs.forEach((doc) {
      ...
      cartTotal = cartTotal + (doc.data() as Map)['total'];
      saving = saving + (((doc.data() as Map)['comparedPrice'] - (doc.data() as Map)['price']) > 0
              ? (doc.data() as Map)['comparedPrice'] - (doc.data() as Map)['price']
              : 0
      );
    });
