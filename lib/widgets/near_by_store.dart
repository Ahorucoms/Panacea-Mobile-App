...
import 'package:panacea/screens/vendor_home_screen.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      child: Center(
                        child: Text(
                          'We do not currently serve in your area, Please try again later or try another location',
                ...
                RefreshIndicator(
                  child: PaginateFirestore(
                    ...
                    itemBuilder: (index, context, document) => Padding(
                      ...
                      //             ),
                      //             Text(
                      //               '${getDistance((document as Map)['location'])}Km',
                      //               overflow: TextOverflow.ellipsis,
                      //               style: kStoreCardStyle,
                      //             ),
                      //             SizedBox(
