...
import 'package:panacea/widgets/search_card.dart';
  ...
  void initState() {
    FirebaseFirestore.instance.collection('products').get().then((QuerySnapshot querySnapshot) {
      querySnapshot.docs.forEach((doc) {
        setState(() {
          document = doc;
          offer = (((doc.data() as Map)['comparedPrice'] - (doc.data() as Map)['price']) / (doc.data() as Map)['comparedPrice'] * 100).toStringAsFixed(0);
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  launch('Call:${_store.storedetails!['mobile']}');
                                },
                              ),
                            ),
                            SizedBox(
